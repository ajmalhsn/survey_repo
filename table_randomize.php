...
$sql3="UPDATE rotation_plan_primary SET rotation_count=$r WHERE id=$id";
if($link->query($sql3)){
   
   
}
 
$sql="SELECT id,attributes FROM rotation_plan r,attributes_q1 a WHERE r.stid = a.id AND rid=$id";
...
$content.='</tbody></table>';
echo '<br>';
echo '<p>Q1I would like to start by reading some statements which reflects different types of people in terms of personal values, beliefs and attitudes. We would like to understand to what extent do you agree with these statements for yourself.</p>';
